...
extern const HelvetiaToolCommand image_clone_stamp_commands[];
extern const HelvetiaToolCommand image_healing_brush_commands[];
...
void image_clone_stamp_on_close(GtkWidget *view);
void image_healing_brush_on_close(GtkWidget *view);
