...
static const HelvetiaTool tools_organizing[] = {
    { "merge_pdfs", "Merge PDFs", "Merge PDFs", "list-add-symbolic", (const char*[]){ "pdfs", "merge", "pdf", NULL }, "merge-pdfs", pdf_merge_create_view, NULL, NULL, pdf_merge_cmds },
    { "split_pdf", "Split PDF", "Split PDF", "list-remove-symbolic", (const char*[]){ "split", "pdf", NULL }, "split-pdf", pdf_split_create_view, NULL, NULL, pdf_split_cmds },
...
static const HelvetiaTool tools_optimization[] = {
    { "pdf_compress", "PDF Compress", "PDF Compress", "application-pdf-symbolic", (const char*[]){ "compress", "pdf", NULL }, "pdf-compress", pdf_compress_create_view, NULL, NULL, pdf_compress_cmds },
